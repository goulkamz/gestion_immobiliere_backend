package com.immobilier.gestionImmobiliere.modules.ville.services;

import com.immobilier.gestionImmobiliere.donnees.pays.model.Pays;
import com.immobilier.gestionImmobiliere.donnees.ville.model.Ville;
import com.immobilier.gestionImmobiliere.donnees.pays.repository.PaysRepository;
...
import com.immobilier.gestionImmobiliere.modules.ville.dto.requests.CreateVilleDTO;
import com.immobilier.gestionImmobiliere.modules.ville.dto.requests.UpdateVilleDTO;
import com.immobilier.gestionImmobiliere.modules.ville.dto.responses.VilleResponseDTO;
...
public class VilleService {
    ...
    private Ville findOrThrow(Long id) {
        return villeRepository.findById(id).orElseThrow(() -> new VilleNotFoundException(id));
    }
