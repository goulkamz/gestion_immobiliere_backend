package com.immobilier.gestionImmobiliere.modules.pays.services;
...
import com.immobilier.gestionImmobiliere.modules.pays.dto.responses.PaysResponseDTO;
...
public class PaysService {
    ...
    public ResponseEntity<?> getAll(Pageable pageable) {
        ...
        return buildSuccessResponse(HttpStatus.OK, "Liste des pays", "PAYS_LIST", result);
    }
    ...
    private Pays findOrThrow(Long id) {
        return paysRepository.findById(id).orElseThrow(() -> new PaysNotFoundException(id));
    }
